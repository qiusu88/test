...
[root server](http://www.root-servers.org/ '关于root server的分布')  
[edns dig支持](https://support.opendns.com/hc/en-us/articles/227987687-Using-dig-for-testing-EDNS-client-subnet  )
...
[har包线上解析地址](http://www.softwareishard.com/har/viewer/ 'chrome抓包可以右键保存为har文件进行传输，以便技术人员分析问题')  
### TCP协议
...
[关于请求被挂起页面加载缓慢问题的追查](http://fex.baidu.com/blog/2015/01/chrome-stalled-problem-resolving-process/ '一篇关于分析chrome pending问题的分析思路，完美 ')  